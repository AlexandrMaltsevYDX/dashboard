...
CORS_ALLOWED_ORIGINS = env(
    ...
    default="http://127.0.0.1:3000,http://localhost:3000,https://expert-crm.ru,https://admin.zagorod-style.ru,https://zagorod-style.ru,https://countryside-style.vercel.app/",
).split(",")
